  ...
  return (
    <div className="pointer-events-none font-bold text-[0.25rem] md:text-xs font-quicksand fixed top-0 left-0 w-screen h-screen z-[9999]  text-white">
      <div className="absolute  left-0 top-8 z-20 text-xs text-white">
        ...
        >
          <p>
            <span className="border text-[8px] py-1 md:py-1 md:px-[0.15rem] rounded-full">H</span>{" "}
            {screenSize.height}
          </p>
          <p>
            <span className="border text-[8px] py-1 md:py-1 md:px-[0.15rem] rounded-full">Y</span>{" "}
            {mousePos.y}
          </p>
        </div>
      </div>

      <div className="absolute  right-6 font-bold bottom-0 z-20 text-xs text-white">
        <div className="text-black flex gap-4 md:px-2 md:py-1 ">
          <p>
      ...
      <div className="absolute bottom-0 left-[47%] text-center  text-black ">
        {screenSize.width / 2}{" "}
      </div>
      ...
      >
       ...
       <div
        className="md:hidden block text-xs absolute top-0 left-1/2 font-semibold -translate-x-1/2  text-black "
